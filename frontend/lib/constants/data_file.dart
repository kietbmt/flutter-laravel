...
class DataFile {
  ...
  static List<Product> getCartModel() {
    List<Product> subList = [];

    // Tạo sản phẩm 1
    Product model = Product(
      id: 1,
      title: "Kid's Girl Shrug",
      price: 22.00, // Thay giá sang double
      photo: "order1.png",
      description: "Female, 1.5 Years", // Mô tả
    );
    subList.add(model);
    ...
    model = Product(
      id: 2,
      title: "Women's Crop Skirt",
      price: 18.00,
      photo: "order2.png",
      description: "Male, 1 Years",
    );
    subList.add(model);
    ...
    model = Product(
      id: 3,
      title: "Kid's Boy Cloths",
      price: 14.00,
      photo: "order3.png",
      description: "Female, 2 Years",
    );
    subList.add(model);
