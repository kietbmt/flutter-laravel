...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('comment.create')}}" class="btn btn-primary shadow-md mr-2">Thêm bình luận</a>
            ...
            <table class="table table-report -mt-2">
                ...
                <tbody>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="text-left">
                            <a href="{{route('product.show', $item->product_id)}}" class="font-medium whitespace-nowrap">{{ $item->product_id }}</a>
                        </td>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('comment.edit', $item->id)}}" class="flex items-center mr-3"> 
